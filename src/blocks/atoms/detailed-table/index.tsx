...
const Table: React.FC<Props> = ({ type, property_type, bed, bath, parking, area }) => {
    return (
        <div className="grid lg:grid-cols-2  mb-3 gap-5">
            <Col >
                <Row name="Property type" value={(property_types as any)[property_type]} />
...
const Col = ({ children }: any) => <div className="border-x border-lightgreen rounded-md overflow-hidden">{children}</div>