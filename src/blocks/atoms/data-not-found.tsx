      ...
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div className="mx-auto max-w-screen-sm text-center">
          ...
          <a
            ...
            className=" cursor-pointer inline-flex bg-lightgray gap-3  focus:ring-4 focus:outline-none focus:ring-primary-300 font-bold rounded-full text-sm px-5 py-2.5 text-center  my-4 items-center"
          >
            <MdFilterAltOff
              color="white"
