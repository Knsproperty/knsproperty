...
const _meta: Props[] = [
    {
        ...
        description: "A cozy family home featuring three bedrooms, two bathrooms, and a spacious living area.",
    },
    {
        bedroom: 4,
        area: 2000,
        ...
        description: "Experience modern luxury living in this exquisite villa boasting four bedrooms, three bathrooms, and elegant interior design.",
    },
    {
        bedroom: 1,
        area: 800,
        ...
        description: "This charming studio apartment offers a comfortable living space, one bedroom, and one bathroom, perfect for singles or couples.",
    },
    {
        bedroom: 5,
        area: 3000,
        ...
        description: "A spacious family residence with five bedrooms, four bathrooms, and ample room for entertainment and relaxation.",
    },
    {
        bedroom: 3,
        area: 1500,
