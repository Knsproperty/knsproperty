...
function SearchSection() {
    return (
        <section className="lg:h-[80vh] h-auto   bg-center bg-[url('https://images.unsplash.com/photo-1600566753376-12c8ab7fb75b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80')] bg-no-repeat bg-cover ">
...
const SimpleSearch = () => {
    ...
    return (
        <div className=" mt-5  rounded-md  p-2 py-4 ">
            ...
            <div className="grid gap-5 lg:max-w-[600px] w-auto">
                <PropertyType />
