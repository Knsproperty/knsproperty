        ...
        <div className="px-4 xl:relative">
          <div className=" flex flex-col lg:flex-row items-center justify-evenly py-14 rounded-3xl">
            ...
            <div className="hidden xl:block xl:absolute right-0">
              <img className=" group-hover:scale-125 transition-all duration-500 ease-linear group-hover:animate-pulse" src="/book.png" alt="Image" />
            </div>
            <div className="hidden md:block bg-white xl:relative px-6 py-3 rounded-3xl">
              ...
              <div className="py-3">
                <button className="w-full py-4 font-semibold text-white bg-primary rounded-xl hover:bg-green-900 transition ease-in-out duration-500">
                  Book
                </button>
              </div>
            </div>
