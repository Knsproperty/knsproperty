"use client";
import { property_types, beds_options, price_min_max } from "@/config/params";
...
import { updateSearchParams } from "@/utils/param";
      ...
      <Container>
        <div className="lg:h-[88px] py-3 lg:py-0 grid lg:grid-cols-[1fr_2fr] grid-cols-[auto_50px] lg:gap-5 gap-2 items-center lg:px-10 px-2">
          ...
          <div className="lg:flex w-full hidden gap-5">
            ...
            <Dropdown name="min" options={price_min_max} value={params.min} />

            <Dropdown name="max" options={price_min_max} value={params.max} />
          </div>
        </div>
