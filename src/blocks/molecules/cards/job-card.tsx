...
export default function Job_Card({
  ...
  return (
    <>
      {/* component */}
      <div className="rounded-md w-full bg-white text-primary px-4 py-4 shadow-md transition transform duration-500 cursor-pointer">
        <div className="flex flex-col justify-start">
          <div className="flex justify-between items-center w-96">
            ...
            <span className="bg-green-500 rounded-full uppercase text-sm px-4 py-1 font-bold shadow-xl">
              {" "}
              Remote{" "}
            </span>
          </div>
          ...
          <div>
            <div className="mt-5 space-y-5">
              <p>{description}</p>
              <p className="line-clamp-3">{requirements}</p>
              <p className="line-clamp-3">{responsibilities}</p>
