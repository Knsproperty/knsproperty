...
export const Select = ({
  ...
  return (
    <select
      className="select w-full max-w-xs border-primary p-2.5 text-gray-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-indigo-600"
      value={value}
