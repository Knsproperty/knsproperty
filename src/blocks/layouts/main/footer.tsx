      ...
      <Container>
        <section className="grid lg:grid-cols-2 w-full py-10 gap-5 lg:gap-0">
          <div className="order-2 lg:order-1">
            ...
            <div className="flex gap-2 items-center">
              <Link
                href={"/"}
                className="text-[13px] font-light hover:underline capitalize"
              >
                Terms & Condition
              </Link>{" "}
              ,
            ...
            <p className="text-[13px] font-light hover:underline capitalize">
              Copyright © Allsopp & Allsopp
            </p>
          </div>
        ...
        <section className="py-5 border-t border-[#efefef]">
          <p className="text-sm font-light text-center">
            Allsopp & Allsopp Real Estate Broker is a company registered in
            Dubai, United Arab Emirates (License No. 613873), 26th Floor, Vision
            Tower, Business Bay, Dubai, PO Box 55720. We are regulated by the
            Real Estate Regulatory Agency under office number 1815.
          </p>
        </section>
      </Container>
    </footer>
